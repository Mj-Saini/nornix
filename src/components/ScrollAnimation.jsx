...
//             min-h-[400px] md:h-screen mt-2 md:mt-10 xl:mt-20 "
//         >
...
//           <div className="content-overlay absolute max-[550px]:bottom-[40%] bottom-[160px] md:bottom-[135px] left-0 w-full h-full flex items-end justify-center z-10">
    ...
    <div ref={containerRef} className="w-full custom_container">
      ...
      {servicesData.map((value, index) => (
        <section
          key={index}
          className="pinned-section flex flex-col items-center justify-center relative 
            h-screen mt-2 md:mt-10 xl:mt-20"
        >
          {/* 🔹 Image with Scale Effect */}
          <img
