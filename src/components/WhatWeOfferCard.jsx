...
const WhatWeOfferCard = () => {
  return (
    <div className="border border-[#09C9EF]/15 rounded-[15px] p-5 xl:py-[30px] xl:px-8 bg-[#212121]/5 blur-[1.5px] hover:border-[#09C9EF] hover:bg-[#242424] hover:blur-[0] duration-300 will-change-transform will-change-filter">
      <span>
        <ExtensionIcon />
      </span>
