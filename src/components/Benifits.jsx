          ...
          <div className="custom_container">
            ...
            <div class="grid-container mt-6 md:mt-10 xl:mt-20">
              <div className="box box1 relative flex justify-center items-center ">
                ...
                <p className="absolute top-[30%] xl:text-[18px] sm:text-[17px] text-[13px] leading-[100%] text-white xl:px-9 px-4">
                  Expand your reach and monetize your AI creativity with our
                  marketplace.
                </p>
                <img
              ...
              <div class="box box2 relative flex justify-center items-center">
                ...
                <p className="absolute lg:top-[40%] md:top-[35%] top-[20%] lg:right-[10px] right-[30px]  xl:text-[18px] sm:text-[16px] text-[14px] w-[60%] md:w-[66%] lg:w-[80%]  leading-[100%] text-white p x-9">
                  Access cutting-edge technology
                </p>
                <p className="absolute  md:bottom-[38%] bottom-[25%] lg:left-[20px] left-[50px] xl:text-[18px] sm:text-[16px] text-[14px] xl:w-[98%] leading-[100%] text-white md:w-[60%] w-[50%] lg:w-[90%]">
              ...
              <div class="box box4 relative flex justify-center items-center">
                ...
                <p className="absolute lg:top-[30%] md:top-[40%] top-[10%] w-[50%] md:w-[90%] sm:left-[60px] left-[40px] lg:left-[10px] xl:text-[18px] sm:text-[16px] text-[12px] leading-[100%]  xl:w-[80%] text-white ">
                  Get technical support and join a
                </p>
                <p className="absolute lg:bottom-[30%] bottom-[25%] lg:right-[30px] right-[60px] xl:text-[18px] sm:text-[16px] leading-[100%] text-[12px] text-end lg:w-[65%] w-[50%] text-white ">
              ...
              <div class="box box5 relative  flex justify-center items-center">
                ...
                <p className="absolute top-[30%] righ t-[30px] xl:text-[18px] sm:text-[17px] text-[12px] leading-[100%] text-center xl:w-[90%] text-white px-3 lg:px-0">
