  ...
  return (
    <div id="benifits" className=" min-h-screen relative overflow-clip flex">
      ...
      <div className="custom_container px-3 mx-auto relative grow">
        <img
          className=" max-sm:w-1/2 mix-blend-color-dodge absolute -right-10 md:-right-20 sm:-bottom-1/4 lg:top-8 xl:-top-12"
          src={sideImg}
          alt="img"
        />
        <div className="py-12 md:py-14 lg:pt-[86px] relative h-full flex justify-center items-center">
          <div>
            {" "}
